...
public class BinarySearch {
	...
	public static void main(String[] args)
	{
		...
		System.out.println("The next tests use int[] a with an odd number of items.");
		...
		System.out.println("The next tests use int[] b = with an even number of items.");
		...
		System.out.println("The next tests use ArrayList<Integer> c with an odd number of items.");
		...
		System.out.println("The next tests use int[] d = with an even number of items.");
